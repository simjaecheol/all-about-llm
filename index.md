...
- [디지털 전환 (DX)](./docs/dx/) - DX의 개념 및 핵심 기술 이해
- [AI Transformation (AX)](./docs/ax/) - 인공지능 전환 전략(Process, People, Platform), 실행 로드맵 및 PoC에서 Production으로의 전환 전략
- [AI Transformation 인프라 (AX Infra)](./docs/ax-infra/) - 에이전틱 엔터프라이즈를 위한 모델 서빙, 관측성 및 실행 샌드박스 인프라
...
- [Serving (Inference Engine)](./docs/inference_engine/) - LLM 서비스 배포 및 운영 방법
...
- [문서 파싱 (Document Parsing)](./docs/document_parsing/) - RAG 품질 향상을 위한 PDF, Office, 웹 문서 등 다양한 형식의 데이터 추출 전략
...
- [Evaluation & Benchmarks](./docs/evaluation/) - 모델 성능 평가 및 개선
